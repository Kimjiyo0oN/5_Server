...
//		out.println("</html>");
		...
		// JSP에게 rep, resp를 전달만 하는 것.
		// -> JSP가 응답을 대신할 뿐이다.
		// 결론 : 페이지 이동 X  -> 주소창의 요청 주소도 변하지 않는 다!
		
		// req 요청관련 정보 데이터 
		// resq 응답하는 방법(기능)
		
		// req.setArribute(String key, Object value)
		
		// Attribute : 속성 == 데이터(값)
		
		req.setAttribute("r", result );
						// Object로 업캐스팅 되어있는 상태 - 다형성
