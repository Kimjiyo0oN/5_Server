...
// -> javax.servlet.http.HttpServlet  추상 메서드 0개 - 개체 생성을 못하게 하기 위해서 
// (추상 메서드(이름만 있는 메서드 상속받은 자식이 무조건 오버라이딩 해야함)를 0개 이상 포함한 클래스)
// - 요청, 응답을 위한 방법(메서드) 제공
// - tomcat에서 제공하는 클래스 
...
//		resp.setCharacterEncoding("UTF-8"); // 사용 X
		...
		out.print(inputName + "님의 나이는 " + inputAge + "세입니다.");
	}
}
