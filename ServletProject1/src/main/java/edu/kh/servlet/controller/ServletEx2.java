...
public class ServletEx2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// rep.getParameter() -> 여러 값 중 첫 번째 값만 얻어옴(String)
		// rep.getParameterValues() -> 여러 값을 모두 얻어옴(String)
		...
		//옵션이 있을 경우에만 출력
		if(opt != null) {
			out.println("<ul list-style-type:\"-\";>");
			//out.println("<ol type=\"-\">");
				//향상된 for문
				for(String o : opt) {
					switch(o) {
					case "shot1": out.printf("<li>1샷 추가</li>\n"); break;
					case "shot2": out.printf("<li>2샷 추가</li>\n"); break;
					case "softly": out.printf("<li>연하게</li>\n"); break;
					}
