...
<!-- prefix : 접두사 
	 uri(Uniform Resource Identifier) -한결같은 변하지 않는 식별자
	 : 자원을 구분하는 식별자(주소 형태)
-->
<!DOCTYPE html>
<html lang="ko">
...
<body>
    ...
    <pre>
        ...
        쉽고 , 표기법을 간다히 태그화 하여 표준으로 제공하는 것. 
    ...
    <ol>
        ...
        <li>Jar File -> Impl, Spec, EL 다운로드</li>
    ...
    <%-- <% int num = 10; %> <%= num %>--%><!-- 이거 하면 보통 EL로 출력 안됨 ${ num } -->
    ...
    <%-- JSTL 작성법 --%>
    <!-- HTML 코드처럼 작성하는 Java코드 -->
    <c:set var="num2" value="20"/> <!-- 기본값 : page 우선순위가 젤 높음  -->
    ...
    <pre>
        ...
        * 주의사항 *
        1) test 속성 값 작성은 무조건 EL 구문이여야 한다.
    ...
    <pre>
        c:choose : when, otherwise를 감싸는 태그
                    (현재 태그 내부에 if ~ else fi ~ else 를 작성하겠다)
